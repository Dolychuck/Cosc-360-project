						...
						<?php
							...
							if(isset($username)) {
								...
								if($error != null) {
									...
									$sql = "SELECT username, firstname, lastname, email,aboutme, userID FROM users WHERE username = '".$username."';";
									...
									$sql = "SELECT headline,PostID FROM userpost ORDER BY postID DESC LIMIT 5;";
